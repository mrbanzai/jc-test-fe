 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Skookum_Db_Adapter_Abstract
{
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'Skookum_Db_Statement';
    ...
    public function query($sql, $bind = array())
    {
        ...
        // load the fetch class
        $fetchClass = 'Skookum_Db_Statement_Pdo_Unprepared';
    ...
    public function foldCase($key)
    {
      ...
      */
    public function usePrepared($use = false)
    {
        $this->_usePreparedStatements = (bool) $use;
        return $this;
    }
